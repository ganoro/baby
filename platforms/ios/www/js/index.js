...
var app = {
    ...
    start : function() {
        ...
        this.bodyImages = [ 'img/1/1-background.png', 'img/3/3-background.png', 'img/5/5-background.png', 'img/2/2-background.png', 'img/back_touch.jpg', 'img/flower.jpg',  'img/flower.jpg' ];
    ...
    main : function() {
        $('.question').bindPopup( { popupContent : app.loadAssetFile("tip1.txt")});
        $('.purchase').bindPopup( { popupContent : app.loadAssetFile("purchase.txt")});
        ...
        $('.puzzle').transition({ delay: 3300, scale: '1.1', duration : 200 }).transition({ scale: '1', duration : 200 });
        $('.painting').transition({ delay: 1300, scale: '1.1', duration : 200 }).transition({ scale: '1', duration : 200 });
        $('.memory').transition({ delay: 2300, scale: '1.1', duration : 200 }).transition({ scale: '1', duration : 200 });
